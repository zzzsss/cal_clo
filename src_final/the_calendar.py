...
class Cal(Frame):
    def __init__(self,root,l,clo=None): # two canvas
        ...
        self.can2.create_window(self.l2*2,self.l2*10,window=self.buttonc,\
                               height=self.l2,width=3*self.l2,tags='origin')
        self.can2.create_window(self.l2*6,self.l2*10,window=self.buttond,\
                               height=self.l2,width=3*self.l2,tags='origin')
        self.can2.create_window(self.l2*4,self.l2*11.5,window=self.buttone,\
                               height=self.l2,width=5*self.l2,tags='origin')
        self.can2.create_window(self.l2*4,self.l2*8.5,window=self.buttonf,\
                               height=self.l2,width=5*self.l2,tags='origin')
        self.can2.create_window(self.l2*4,self.l2*7,window=self.buttong,\
                               height=self.l2,width=5*self.l2,tags='origin')
        #show attribute:
        self._1=1
        ...
        self.can2.create_window(self.l2*4,self.l2*1.5,window=self.label_y,\
                               height=2*self.l2,width=5*self.l2,tags='origin')
        self.can2.create_window(self.l2*3,self.l2*3.5,window=self.label_m,\
                               height=2*self.l2,width=7*self.l2,tags='origin')
        self.can2.create_window(self.l2*7,self.l2*3.5,window=self.label_d,\
                               height=2*self.l2,width=2*self.l2,tags='origin')
        self.can2.create_window(self.l2*4,self.l2*5.5,window=self.label_wd,\
        ...
        self.can2.create_window(self.l2*4,self.l2*16,window=self.sth_can,\
                               tags='origin')
        self.scrollY = Scrollbar(orient=VERTICAL,command=self.sth_can.yview)
        self.can2.create_window(self.unit*8,self.unit*16,window=self.scrollY,\
