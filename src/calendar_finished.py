...
class Cal(Frame):
    def __init__(self,root,l,clo=None): # two canvas
        ...
        self.can2.create_window(self.l2*5,3*self.l2,window=self.label_y,\
                               height=2*self.l2,width=5*self.l2,tags='origin')
        self.can2.create_window(self.l2*4,self.l2*5,window=self.label_m,\
                               height=2*self.l2,width=7*self.l2,tags='origin')
        self.can2.create_window(self.l2*8,self.l2*5,window=self.label_d,\
                               height=2*self.l2,width=2*self.l2,tags='origin')
        self.can2.create_window(self.l2*5,self.l2*7,window=self.label_wd,\
